...
-- style
insert into style(nom_style) values ('robe');
insert into style(nom_style) values ('jupe');
insert into style(nom_style) values ('tee-shirt');
...
insert into stadeDemandeClient(type_stade,quantite) values ('Non alloue',0);
insert into stadeDemandeClient(type_stade,quantite) values ('PROTO_1',1);
insert into stadeDemandeClient(type_stade,quantite) values ('PROTO_2',2);
insert into stadeDemandeClient(type_stade,quantite) values ('PROTO_3',3);
insert into stadeDemandeClient(type_stade,quantite) values ('TDS_2',4);
insert into stadeDemandeClient(type_stade,quantite) values ('TDS_3',5);
insert into stadeDemandeClient(type_stade,quantite) values ('PPS_1',6);
insert into stadeDemandeClient(type_stade,quantite) values ('PPS_2',7);
insert into stadeDemandeClient(type_stade,quantite) values ('PPS_3',8);
insert into stadeDemandeClient(type_stade,quantite) values ('PPS_4',9);
insert into stadeDemandeClient(type_stade,quantite) values ('CONFORMITE',10);
insert into stadeDemandeClient(type_stade,quantite) values ('PROD',11);
insert into stadeDemandeClient(type_stade,quantite) values ('Nego_1',12);
insert into stadeDemandeClient(type_stade,quantite) values ('Nego_2',13);
insert into stadeDemandeClient(type_stade,quantite) values ('Nego_3',14);
insert into stadeDemandeClient(type_stade,quantite) values ('Mock_up_TDS',15);
insert into stadeDemandeClient(type_stade,quantite) values ('Mock_up_PPS',16);
insert into stadeDemandeClient(type_stade,quantite) values ('Mock_up_Proto',17);
insert into stadeDemandeClient(type_stade,quantite) values ('Shotting_TDS',18);
insert into stadeDemandeClient(type_stade,quantite) values ('Shotting_PPS',19);
insert into stadeDemandeClient(type_stade,quantite) values ('Shotting_Proto',20);
insert into stadeDemandeClient(type_stade,quantite) values ('SHIPMENT_SAMPLE',30);
insert into stadeDemandeClient(type_stade,quantite) values ('GARMENT_SAMPLE',31);
