        ...
        <div class="col-lg-12">
            <div class="card" id="kanban-container"
                ...
                <div class="card-header text-center" style="display: flex; justify-content: space-between;">
                    <h3 class="entete">BROADERIE MAIN PLANNING</h3>
                </div>
...
<script>
    ...
    modalBody.innerHTML = `<p>${info}</p>
                <form>
                    <div class="form-group">
                        <label for="input1">Effectif</label>
                        <input type="number" class="form-control" id="input1">
                    </div>
                    <div class="form-group">
                        <label for="input2">Efficience</label>
                        <input type="text" class="form-control" id="input2" value="100">
                    </div>
                    <div class="form-group">
                        <label for="input2">Heure de Travail</label>
