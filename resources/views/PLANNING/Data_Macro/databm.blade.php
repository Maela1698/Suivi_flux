        ...
        <div class="col-md-11">
            <div class="card col-12 carte" style="margin-left: 50px;">
                <div class="card-header d-flex justify-content-between align-items-center entete">
                    <h3 class="entete">Data BM :  DEMANDE CLIENT</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="form-valide" action="{{ route('LRP.createDataBm') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                                @csrf
                                <input type="hidden" name="qteprev" value="{{$deets[0]->qte}}">
                                <div class="form-group row">
                                    <div class="col-3">
                                        <div class="row no-gutters">
                                            <div class="col-12">
                                                <label for="tempsbrod" class="texte"><b>Heure Brod</b></label>
                                            </div>
                                            <div class="col-12">
                                                <input type="text" name="tempsbrod" id="tempsbrod" class="form-control" value="{{$deets[0]->smv_brod_main}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="row no-gutters">
                                            <div class="col-12">
                                                <label for="capacite_bm" class="texte"><b>Capacite</b></label>
                                            </div>
                                            <div class="col-12">
                                                <input type="text" name="capacite_bm" id="capacite_bm" class="form-control" value="{{$capacite_bm[0]->capacite_bm}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                ...
                                <div class="form-group row">
                                    <div class="col-4">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-12">
                                                {{-- <input type="text" name="heure_grmt" id="heure_grmt" class="form-control" value="{{$heuregrmt[0]->heuregrmt ?? 'Aucune donnée'}}"> --}}
                                                <input type="text" name="heure_grmt" id="heure_grmt" class="form-control" value="{{$heuregrmt ?? 'Aucune donnée'}}">
                                    ...
                                    <div class="col-4">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-12">
                                                <input type="text" id="" class="form-control" value="{{$deets[0]->mois_date_max}}" >
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-3">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-12">
                                                <input type="date" name="inliner" id="inliner" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="efficience" id="efficience" class="form-control" value="{{$deets[0]->efficience ?? 'Aucune donnée'}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-12">
                                                <input type="number" name="effectif_brod_main" id="effectif_brod_main" class="form-control" value="{{$details[0]->effectif_bm ?? 'Donnée disponible' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <textarea name="commentaire" id="commentaire" class="form-control" value="">{{ $details[0]->commentaire ?? 'Donnée disponible' }}</textarea>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="confirmUpdateModalLabel">Modifier Data Broderie Main</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('LRP.updateDataBm') }}" method="POST" id="updateForm">
                    @csrf
                    <input type="hidden" name="id" value="{{ $details[0]->id ?? 'Donnée disponible'  }}">
                    {{-- <input type="text" name="id" value="{{ $details->disponibilite }}"> --}}
                    <div class="form-group row">
                        <div class="col-3">
                            <div class="row no-gutters">
                                <div class="col-12">
                        ...
                        <div class="col-3">
                            <div class="row no-gutters">
                                <div class="col-12">
                                    <label for="besoin_loading" class="texte"><b>Besoin L...</b></label>
                                </div>
                                <div class="col-12">
                                    <input type="text" name="capacite_j" id="capacite_j" class="form-control" value="{{$capacite_j}}" >
                                </div>
                    ...
                    <div class="form-group row">
                        <div class="col-6">
                            <div class="row no-gutters">
                                ...
                                <div class="col-12">
                                    <input type="text" name="heure_grmt" id="heure_grmt" class="form-control" value="{{$heuregrmt}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
