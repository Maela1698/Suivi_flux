        ...
        <div class="row">
            ...
            <div class="card col-md-12" >
                <div class="card-header d-flex justify-content-between align-items-center entete">
                    <h3 class="entete">MODIFIER MACRO</h3>
                </div>

                <div class="card-body">
                    <form action="{{ route('LRP.updateMacro') }}" method="post" autocomplete="off">
                        @csrf
                        @if (!empty($macro))
                                @foreach ($macro as $data)
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="utilisation" class="col-form-label" style="color: rgb(105, 102, 102);">Macro</label>
                                                <select class="form-control" id="macro" name="macro" required readonly>
                                                    @if(!empty($type_macro))
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="mois" name="mois" required readonly>
                                                    <option value="{{ $data->mois }}" readonly>{{ $data->mois }}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="annee" name="annee" value="{{ $data->annee }}" placeholder="" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="jours_ouvrables" name="jours_ouvrables" value="{{ $data->jourouvrable }}" readonly>
                                                {{-- readonly --}}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="effectif" name="effectif" value="{{ $data->effectif_macro }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="efficience" class="col-form-label" style="color: rgb(105, 102, 102);">Efficience/Rendement</label>
                                                <input type="text" class="form-control" id="efficience" name="efficience" value="{{ $data->efficience_macro }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4" id="besoin-effectif-container" style="display:none;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="besoin_effectif" name="besoin_effectif" value="{{ $data->besoin_effectif }}">
                                            </div>
                                        </div>
                            ...
                            <div class="alert alert-danger">
                                <p>Aucune donnée trouvée pour cette macro.</p>
                            </div>
                        @endif
                            ...
                            <input type="hidden" name="idmacro" value="{{ $idmacro }}">
                            {{-- <input type="text" name="idmacro" value="{{ $idmacro }}"> --}}
