                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            <h3 class="card-title text-white" style="margin-bottom: 5px; font-size: calc(0.1em + 1vw);">
                                Nbr Points</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $nbrPoints }}</h2>
                            </div>
                        </div>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            <h3 class="card-title text-white" style="margin-bottom: 5px; font-size: calc(0.1em + 1vw);">
                                Prime</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $prime }}</h2>
                            </div>
                        </div>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            <h3 class="card-title text-white" style="margin-bottom: 5px; font-size: calc(0.1em + 1vw);">
                                Retard</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $retard }}</h2>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="card col-12">
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">SUIVI PLACEUR </h3>
                </div>


                <form action="{{ route('DEV.rechercheSuiviPlaceur') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-1">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                <input type="text" id="nomEmploye" name="nomEmploye" class="form-control" placeholder="Placeur"
                                    value="{{ $nomEmploye }}">
                ...
                <div class="table-responsive" style="margin-top: -15px;">
                    <table class="table student-data-table m-t-20 table-hover mt-3" style="color: black">
                        ...
                        <tbody style="cursor: pointer;">
                            @for ($i = 0; $i < count($placeur); $i++)
                                <tr>
                                    <td style="cursor: pointer;">{{ \Carbon\Carbon::parse($placeur[$i]->datedebut)->format('d/m/y') }}</td>
                                    <td> {{ \Carbon\Carbon::parse($placeur[$i]->datefin)->format('d/m/y') }}</td>
                                    <td> {{ \Carbon\Carbon::parse($placeur[$i]->deadline)->format('d/m/y') }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->theme }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->nom_style }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->nom_modele }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->nomtier }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->type_saison }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->stadesdc }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->quantitesdc }} pcs</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->type_tissus }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->laize_utile }} m</td>
                                    <td  style="cursor: pointer;">{{ $placeur[$i]->nom }} {{ $placeur[$i]->prenom }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->typeplacement }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->pointplacement }}</td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->nbmarkeur }} </td>
                                    <td style="cursor: pointer;">{{ $placeur[$i]->commentaire }} </td>
                                </tr>
                            @endfor
                        </tbody>
                    </table>
