        ...
        <div class="row">
            <div class="card col-12">
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">TRANSMISSION MERCH </h3>
                </div>
                <form action="{{ route('DEV.rechercheTransmissionMerch') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-1">
                        ...
                        <tbody style="cursor: pointer;">
                            @for ($i = 0; $i < count($transmission); $i++)
                                <tr>
                                    ...
                                    <td> {{ \Carbon\Carbon::parse($transmission[$i]->deadline)->format('d/m/y') }}
                                    </td>
                                    ...
                                    <td style="cursor: pointer;">{{ $transmission[$i]->stadesdc }}</td>
                                    <td style="cursor: pointer;">{{ \Carbon\Carbon::parse($transmission[$i]->dateenvoie)->format('d/m/y') }}</td>
                                    <td style="cursor: pointer;">{{ $transmission[$i]->qteenvoie }}</td>
