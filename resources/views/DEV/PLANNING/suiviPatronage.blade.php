        ...
        <div class="row">
            <div class="card col-12">
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">SUIVI PATRONIER </h3>
                </div>


                <form action="{{ route('DEV.rechercheSuiviPatronage') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-1">
                ...
                <div class="table-responsive" style="margin-top: -15px; mt-3">
                    <table class="table student-data-table m-t-20 table-hover mt-3" style="color: black">
                        <thead>
                            <tr>
                                ...
                                <th>Type patron</th>
                                <th>Point Patronage</th>
                                <th>Nom Patronier</th>
                                <th>Commentaire</th>
                            </tr>
                        </thead>
                        <tbody style="cursor: pointer;">
                            @for ($i = 0; $i < count($patronage); $i++)
                                <tr>
                                    <td style="cursor: pointer;">
                                        {{ \Carbon\Carbon::parse($patronage[$i]->datedebut)->format('d/m/y') }}</td>
                                    <td> {{ \Carbon\Carbon::parse($patronage[$i]->datefin)->format('d/m/y') }}</td>
                                    <td> {{ \Carbon\Carbon::parse($patronage[$i]->deadline)->format('d/m/y') }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->theme }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->nom_modele }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->nom_style }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->nomtier }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->type_saison }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->type_stade }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->quantitesdc }} pcs</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->typepatron }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->pointpatronage }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->nom_patronier }}
                                        {{ $patronage[$i]->prenom_patronier }}</td>
                                    <td style="cursor: pointer;">{{ $patronage[$i]->commentaire }}</td>
                                </tr>
                            @endfor
                        </tbody>
                    </table>
