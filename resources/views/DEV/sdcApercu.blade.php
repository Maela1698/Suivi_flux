...
<div class="content-body">
    <div class="container-fluid mt-3">
        ...
        <div id="sdcpdf" class="card col-12">
            ...
            <center>
                <div class="row mt-3" style="border-bottom: solid 1px gray;font-size: 10px;height: 100px;margin-top: -50px;height: 75px;">
                ...
                <table class="table table-bordered" style="border: 1px solid; border-collapse: collapse;width: 500px;font-size: 10px;">
                    ...
                    <tbody style="color: black;">
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid;">{{ $ds->paquet }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
            ...
            <center>
                <table class="table table-bordered" style="border: 1px solid; border-collapse: collapse; font-size: 10px;">
                    <tbody>
                        ...
                        <tr style="display: flex; flex-wrap: wrap;">
                            ...
                            <td style="border: 1px solid; flex: 1 1 5%;"> <img src="data:image/png;base64,{{ $ti->photo }}" alt="" style="width: 30px; height: auto;"></td>
                            <td style="border: 1px solid; flex: 1 1 10%; display: grid; grid-template-columns: repeat(5, 1fr); gap: 5px; width: -20px;">
                                ...
                                <div class="form-check" style="display: flex; align-items: center; font-size: 10px;">
                                    <input
                            ...
                            <td style="border: 1px solid; flex: 1 1 20%;">
                                <textarea id="commentaires{{ $ti->type_tissus }}{{ $dm }}"  name="commentaire" placeholder="Commentaire" style="width: 100%;height:10px ; resize: both; border: none; border-bottom: solid 1px lightgrey; font-size: 10px;"></textarea>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
                ...
                <table class="table table-bordered" style="border: 1px solid; border-collapse: collapse; font-size: 10px;">
                    <tbody>
                        ...
                        <tr style="display: flex; flex-wrap: wrap;">
                            ...
                            <td style="border: 1px solid; flex: 1 1 20%;">
                                <textarea id="commentaires{{ $acc->type_accessoire }}{{ $dm }}"  name="commentaire" placeholder="Commentaire" style="width: 100%;height:10px ; resize: both; border: none; border-bottom: solid 1px lightgrey; font-size: 10px;"></textarea>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
            ...
            <div class="form-validation" style=" width: 100%;text-align: center;background-color: #509baf;font-size: 10px;margin-top: -16px;height: 15px;">
...
<div class="col-md-1 fixed-top-right">
    <div class="form-group row">
        <div class="col-lg-8 ml-auto text-right d-flex justify-content-end">
            ...
            <form action="{{ route('DEV.sdc') }}" method="get">
