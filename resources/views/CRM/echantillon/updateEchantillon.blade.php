<title>Modification Echantillon</title>
...
<div class="content-body">
        ...
        <div class="row" style="margin-left: 60px;">
            <div class="card col-md-12">
                <div class="card-header d-flex justify-content-between align-items-center entete">
                    <h3 class="entete">MODIFICATION ECHANTILLON</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('CRM.modifEchantillon') }}" method="post" autocomplete="off">
                        @csrf
 ...
 <a href="{{ route('CRM.echantillon') }}" class="btn btn-info mr-3">Retour</a>
                                    <button type="submit" class="btn btn-success mr-3"
                                        style="height: 35px;">Enregistrer</button>

                                </div>
                            </div>
                        @else
                            <p>Il n'y pas encore d'envoie echantillon</p>
                            <a href="{{ route('CRM.echantillon') }}" class="btn btn-info mr-3">Retour</a>
                        @endif
