        ...
        <div class="card col-12 carte">
            ...
            <div class="card-body">
                <div class="form-validation">
                    <form class="form-valide" action="{{ route('CRM.insertSdc') }}" method="post">
                        @csrf
                        <input type="hidden" name="idStade" value="{{ $idStade }}">
                        <div class="form-group row">
                            <div class="col-3">
                                <div class="row no-gutters">
                                    <div class="col-12">
                                        <label class="col-form-label" style="color: black;">Stade:
                                            {{ $stade->type_stade }} </label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-3">
                                <div class="row no-gutters">
                                    <div class="col-12">
                                        <label class="col-form-label" style="color: gray;">Date d'envoie client </label>
                                    </div>
                                    <div class="col-12">
                                        <input type="date" class="form-control" name="dateEnvoie" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table" style="background-color: lightgrey;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" style="color: black;">{{ $t->unite_taille }}</th>
                                    <td><input type='number' style="width: 100%; box-sizing: border-box; padding: 4px;border: none;" name="quantiteclient[]" value="0"></td>
                                    <td><input type='number' style="width: 100%; box-sizing: border-box; padding: 4px;border: none;" name="keep[]" value="0"></td>
                                    <input type="hidden" name="id_unite_taille_dc[]" value="{{ $t->id }}">
                                </tr>
                                @endforeach
                        ...
                        <div class="form-group row">
                            <div class="col-lg-8 ml-auto text-right d-flex justify-content-end">
                                ...
                                <button type="submit" class="btn btn-success  mr-3"
                                    style="margin-left: 15px">Ajouter</button>
                            </div>
                    </form>
