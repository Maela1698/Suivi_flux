...
<div class="col-md-1 fixed-top-right">
    <div class="form-group row">
        <div class="col-lg-8 ml-auto text-right d-flex justify-content-end">
            <form action='smv' method='get'>
                <input type='hidden' name='idDemandeClient' value="<%= listev_demandeClient.get(0).getId()%>">
                <button type="submit" class="btn btn-info mr-3">Retour</button>
            </form>
            <form action="{{ route('CRM.ajoutSmv') }}" method="get">
            ...
            </form> <button type="submit" onclick="exportToPDF()" class="btn btn-success mr-3"
