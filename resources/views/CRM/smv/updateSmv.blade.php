        ...
        <div class="row">
            ...
            <div class="card col-md-12">
                <div class="card-header d-flex justify-content-between align-items-center entete">
                    <h3 class="entete">Modifier SMV</h3>
                </div>
                @if (count($smv) != 0)
                    <div class="card-body">
                        <form action="{{ route('CRM.modifSmv') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-lg-8 ml-auto text-right d-flex justify-content-end">
                                    ...
                                    <button type="button" id="retourButton" name="action" value="retour"
                                        class="btn btn-info mr-3">Retour</button>
                                </div>
                            </div>
                        </form>
                    </div>
                @else
                    <p>Il n'y a pas encore de SMV</p>
