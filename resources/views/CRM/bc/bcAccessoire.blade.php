        ...
        <div class="card col-12 carte">
            ...
            <div class="card-body">
                ...
                <div class="input-group mb-1" style="width: 370px;">
                    ...
                    <input type="date" class="form-control custom-input" placeholder="jj/mm/aaaa">
                </div>
                <div class="input-group mb-1" style="width: 370px;">
                    <div class="input-group-prepend">
                        <span class="input-group-text" style="width: 151px;">N° BC :</span>
                    </div>
                    <input type="text" class="form-control" value="13/LOI/2024" readonly>
                </div>
                ...
                <div class="col-5" style="float: right;margin-top: -155px;">
                    <div class="input-group mb-1" style="width: 370px;">
                        ...
                        <input type="text" class="form-control" value="{{ $client[0]->nomtier }}" readonly>
                    </div>
                    <div class="input-group mb-1" style="width: 370px;">
                        <div class="input-group-prepend">
                            <span class="input-group-text" style="width: 151px;">Saison :</span>
                        </div>
                        <input type="text" class="form-control" value="{{ $client[0]->type_saison }}" readonly>
                    </div>
                </div>
