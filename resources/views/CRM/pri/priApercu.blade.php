...
<script>
    function exportToPDF() {
        const element = document.getElementById("pripdf");

        const options = {
            filename: 'PRI_{{ $detaildemande[0]->nom_modele }}_{{ $detaildemande[0]->nomtier }}_{{ $detaildemande[0]->type_stade }}.pdf',
            image: {
                type: 'jpeg',
                quality: 0.98
            },
...
<div class="content-body">
    <div class="container-fluid mt-3">
        ...
        <div id="pripdf" class="card col-12">
            <div class="card-body row" style="display: flex; align-items: center;border-bottom: solid 1px gray">
                ...
                <div class="col-6"
                    ...
                    <div class="client">
                        <h6>HISTORIQUE PRI : {{ $detaildemande[0]->nomtier }}</h6>
                    </div>
                </div>
            </div>
            <center>
                <div class="row mt-3" style="border-bottom: solid 1px gray;font-size: 11px;height: 100px;">
                    ...
                    <div class="col-4">
                        <div class="card-body" style="margin-left: 60px;margin-top: -5px;">
                            <p class="texte" style="text-align: left;margin-bottom: 3px;"><b>MERCH :</b></p>
                        </div>
                    </div>
                </div>
            </center>
            ...
            <center>
                <table class="table table-striped" style="font-size: 13px;">
                    ...
                    <tbody style="color: black;">
                        @foreach ($pri as $p)
                            <tr>
                                <td>{{ \Carbon\Carbon::parse($p->date_pri)->format('d/m/y') }}</td>
                                <td>{{ $p->prix }}</td>
                                <td>{{ $p->unite }}</td>
                                <td>{{ $p->commentaire }}</td>
                            </tr>
...
<div class="col-md-1 fixed-top-right">
    <div class="form-group row">
        <div class="col-lg-8 ml-auto text-right d-flex justify-content-end">
            ...
            <form action="{{ route('CRM.ajoutPri') }}" method="get">
                <input type="hidden" name="stade" value="{{ $detaildemande[0]->id_stade }}">
                <button type="submit" class="btn btn-secondary mr-3">Ajouter</button>
            </form>
