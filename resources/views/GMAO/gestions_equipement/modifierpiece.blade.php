            ...
            <div class="col-lg-12 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <div class="col-sm-4">
                           <h3  class="entete">MODIFIER PIECE(S)</h3>
                        </div>
                    </div>
                    <div class="card-header">
                        <h4 class="card-title">Modifier pièce(s)</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="POST" action="{{ route('piece.update', ['idpiece' => $piece->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="date" class="form-control" placeholder="Date Insertion" id="date_ajout" name="date_ajout" value="{{$piece->date_ajout_piece}}">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Designation</label>
                                        <input type="text" class="form-control" placeholder="Désignation" id="designation" name="designation" value="{{$piece->designation}}">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Reference</label>
                                        <input type="text" class="form-control" placeholder="Reference" id="reference" name="reference" value="{{$piece->reference}}">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Duree de vie <small><em>en heure</em></small></label>
                                        <input type="text" class="form-control" placeholder="Duree de vie" id="duree_vie" name="duree_vie" value="{{$piece->dureevie}}">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label>Nombre</label>
                                        <input type="number" class="form-control" placeholder="nombre de pièces" id="nbr" name="nbr" min=1 value="{{$piece->nombre}}">
                                    </div>
                                </div>
