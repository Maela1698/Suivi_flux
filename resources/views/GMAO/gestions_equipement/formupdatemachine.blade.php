        ...
        <div class="row">
            <div class="card col-12">
                <div class="card-header d-flex justify-content-between align-items-center entete">
                    <h3 class="entete">Modifier cette machine</h3>
                </div>

                <div class="card-body">
                    <div class="form-validation">
                        <form class="form-valide" action='{{route('GMAO.updatemachine',['idmachine' => $details_machine_filtre->id_machine])}}'' method="post" enctype="multipart/form-data" autocomplete="off" id="machine-form">
                            @csrf
                            <div class="form-group row">
                                <div class="col-4">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <input type="radio" id="propriete" name="type" value="100" class="form-check-input" {{ $details_machine_filtre->proprietee == 100 ? 'checked' : '' }}>
                                            <label for="propriete" class="form-check-label">Propriété</label>
                                        </div>
                                        <br>
                                        <div class="col-12">
                                            <input type="radio" id="emprunt" name="type" value="200" class="form-check-input" {{ $details_machine_filtre->proprietee == 200 ? 'checked' : '' }}>
                            ...
                            <div class="form-group row">
                                <div class="col-4">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <input type="date" class="form-control" name="date_entree" value="{{$details_machine_filtre->dateentreemachine}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <input type="date" class="form-control" name="date_fin_contrat" value="{{$details_machine_filtre->datefincontrat ?? ''}}"disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row d-flex">
                                <div class="col-2">
                                    ...
                                    <input type="text" id="nomfournisseur" class="form-control" placeholder="Fournisseur" value="{{$details_machine_filtre->fournisseur ?? ''}}" required>
                                    <input type="hidden" id="idfournisseur" class="form-control" name="nomfournisseur" value="{{$details_machine_filtre->id_fournisseur_machine ?? ''}}">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="hidden" id="idmarque" class="form-control" name="marque" value="{{$details_machine_filtre->marque ?? ''}}">
                                    <ul id="suggestionsListMarque" class="list-group mt-2" style="display: none;" value="{{$details_machine_filtre->id_machine ?? ''}}"></ul>
                                </div>

                                <div class="col-2">
                                    <label for="id_fr" class="col-form-label">Id depuis Fournisseur</label>
                                    <input type="text" id="id_fr" class="form-control" name="id_fr" value="{{$details_machine_filtre->id_from_fournisseur ?? ''}}" >
                                </div>
                                <div class="col-2">
                                    <label for="code" class="col-form-label">Code</label>
                                    <input type="text" id="code" class="form-control" name="code" value="{{$details_machine_filtre->codemachine ?? ''}}" required>
                                </div>

                                <div class="col-2">
                                    <label for="categorie" class="col-form-label">Catégorie <small><em>**</em></small></label>
                                    <input type="text" id="categorie" class="form-control" placeholder="Catégorie" value="{{$details_machine_filtre->categorie ?? ''}}" required>
                                    <input type="hidden" id="idcategorie" class="form-control" name="categorie" value="{{$details_machine_filtre->idcategoriemachine ?? ''}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-3">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <input type="text" id="reference" name="reference" class="form-control" placeholder="Référence" value="{{$details_machine_filtre->reference ?? ''}}" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <input type="text" id="capacite" name="capacite" class="form-control" placeholder="Capacite" value="{{$details_machine_filtre->capacite ?? ''}}">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-row d-flex">
                                <div class="col-3">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <input type="text" class="form-control" id="coutprestation"  name="coutprestation" value="{{$details_machine_filtre->cout_prestation ?? ''}}" disabled>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-3">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <input type="text"  class="form-control"  name="prixu"  value="{{$details_machine_filtre->prixu ?? ''}}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row d-flex">
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                            <label class="custom-file-upload">
                                                <input type="file" class="form-control-file" name="photo_machine" value="value="{{$details_machine_filtre->cout_prestation ?? ''}}"">
                                ...
                                <div class="col-4">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-12">
                                                <input type="file" class="form-control-file" name="document" value="{{$details_machine_filtre->dossier ?? ''}}">
                                            <label class="custom-file-upload">
