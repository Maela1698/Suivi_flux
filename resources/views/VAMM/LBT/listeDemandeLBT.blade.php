        ...
        <div class="row">
            <div class="card col-12">
                ...
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">LISTE DES DEMANDES LBT</h3>
                </div>

                <form action="{{ route('LBT.listeLBT') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-1">
                        ...
                        <tbody style="cursor: pointer;">
                            @for ($i = 0; $i < count($demande); $i++)
                                @for ($j = 0; $j < count($nombreInspection); $j++)
                                    <tr>
                                        <td onclick="window.location.href = '{{ route('LBT.detailDemandeLBT', ['idDemande' => $demande[$i]->id_demande_client]) }}';"
