        ...
        <div class="col-md-12">
            <div class="card col-12 carte">
                <div class="d-flex justify-content-between align-items-center entete">
                    <h3 class="entete mt-3">PARAMETRE LAVAGE</h3>
                ...
                <div class="card-body">
                    @if (count($parametre) != 0)
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row no-gutters mt-3">
                                    <div class="col-5 mr-2">
                                        ...
                                        <input type="text" class="form-control" name="poidsUnitaire" value="{{ $parametre[0]->poids_unitaire }}">
                                    </div>
                                    <div class="col-5 ">
                                        <label class="texte">Poids d'une passe(kg)</label><br>
                                        <input type="text" name="poidsPasse" class="form-control" value="{{ $parametre[0]->poids_passe }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="row no-gutters mt-3">
                                    <div class="col-5 mr-2">
                                        <label class="texte">Temps/Passe etsimé(mn)</label><br>
                                        <input type="text" class="form-control" name="tempsPasseEstime"
                                            value="{{ $parametre[0]->temps_passe_estime }}">
                                    </div>
                                    <div class="col-5">
                                        <label class="texte">Temps/Passe réel(mn)</label><br>
                                        <input type="text" name="tempsPasseReel" class="form-control" value="{{ $parametre[0]->temps_passe_reel }}">
                                    </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="row no-gutters mt-3">
                                    <div class="col-5 mr-2">
                                        <label class="texte">Conso total d'eau </label><br>
                                        <input type="text" class="form-control" name="consoTotalEau" value="{{ $parametre[0]->conso_total_eau }}">
                                    </div>
                                    <div class="col-5">
                                        <label class="texte">Prix lavage(Euro)</label><br>
                                        <input type="text" name="prixLavage" class="form-control" value="{{ $parametre[0]->prix_lavage }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-3">
                                        <label class="texte">Temps total</label><br>
                                        <input type="text"  class="form-control" value="{{ $parametre[0]->temps_total }}">
                                    </div>
                                </div>
                            </div>
                    ...
                    @else
                        <span class="texte">Il n'y pas encore de parametre lavage sur cette demande</span>
                    @endif
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg-custom" role="document">
                    <div class="modal-content modal-content-custom">
                        <div class="modal-header">
                            <h5 class="modal-title" id="choixEtapeModalLabel">Insertion paramètre lavage</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="{{ route('LBT.insertParametreLavage') }}" method="POST"
                                autocomplete="off">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="row no-gutters mt-3">
                                            <div class="col-5 mr-2">
                                                <label class="texte">Poids unitaire(kg)</label><br>
                                                <input type="text" class="form-control" name="poidsUnitaire"
                                                    value="0">
                                            </div>
                                            <div class="col-5 ">
                                                <label class="texte">Poids d'une passe(kg)</label><br>
                                                <input type="text" name="poidsPasse" class="form-control"
                                                    value="0">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row no-gutters mt-3">
                                            ...
                                            <div class="col-5">
                                                <label class="texte">Temps/Passe réel(mn)</label><br>
                                                <input type="text" name="tempsPasseReel" class="form-control"
                                                    value="0">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row no-gutters mt-3">
                                            <div class="col-5 mr-2">
                                                <label class="texte">Conso total d'eau </label><br>
                                                <input type="text" class="form-control" name="consoTotalEau"
                                                    value="0">
                                            </div>
                                            <div class="col-5">
                                                <label class="texte">Prix lavage(Euro)</label><br>
                                                <input type="text" name="prixLavage" class="form-control"
                                                    value="0.12">
                                            </div>
                                        </div>
                                    </div>
