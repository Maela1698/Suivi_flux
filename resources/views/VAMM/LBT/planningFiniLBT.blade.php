        ...
        <div class="row">
            ...
            <div class="card col-12">
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">PLANNING FINI LBT</h3>
                </div>
                ...
                <div class="kanban-board">
                    <div class="kanban-column">
                        ...
                        @for ($i = 0; $i < count($demandeP); $i++)
                            @if ($demandeP[$i]->etat_apro_produit_chimique == 1)
                    ...
                    <div class="kanban-column">
                        ...
                        @for ($i = 0; $i < count($demandeChange); $i++)
                            @if ($demandeChange[$i]->etat_pesage == 1)
                                <div class="kanban-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <button id="inactiveButton" class="btn btn"
                        ...
                        @for ($i = 0; $i < count($demandeProd); $i++)
                            @if ($demandeProd[$i]->etat_pesage == 1)
                                <div class="kanban-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <button id="inactiveButton" class="btn btn"
                    ...
                    <div class="kanban-column">
                        ...
                        @for ($i = 0; $i < count($demandeP); $i++)
                            @if ($demandeP[$i]->etat_lavage_blanc_teint == 1)
                                <div class="kanban-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <button id="inactiveButton" class="btn btn"
                        ...
                        @for ($i = 0; $i < count($demandeChange); $i++)
                            @if ($demandeChange[$i]->etat_lavage_blanc_teint == 1)
                                <div class="kanban-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <button id="inactiveButton" class="btn btn"
                    ...
                    <div class="kanban-column">
                        ...
                        @for ($i = 0; $i < count($demandeP); $i++)
                            @if ($demandeP[$i]->etat_test_shrinkage == 1)
                                <div class="kanban-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <button id="inactiveButton" class="btn btn"
                        ...
                        @for ($i = 0; $i < count($demandeChange); $i++)
                            @if ($demandeChange[$i]->etat_test_shrinkage == 1)
                                <div class="kanban-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <button id="inactiveButton" class="btn btn"
