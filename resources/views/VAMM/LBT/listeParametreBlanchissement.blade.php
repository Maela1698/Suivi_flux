...
@include('CRM.header')
<title>ParametreBlanchissement</title>
@include('CRM.sidebar')
        ...
        <div class="col-md-12">
            <div class="card col-12 carte">
                <div class="d-flex justify-content-between align-items-center entete">
                    <h3 class="entete mt-3">PARAMETRE BLANCHISSEMENT</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="row no-gutters mt-3">
                                ...
                                <div class="col-5 ">
                                    ...
                                    <input type="text" name="poidsUnitaire" class="form-control"
                                    value="{{ $parametre[0]->poids_unitaire }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="row no-gutters mt-3">
                                <div class="col-5 mr-2">
                                    <label class="texte">Poids d'une passe(kg)</label><br>
                                    <input type="text" class="form-control" name="poidPasse"
                                          value="{{ $parametre[0]->poids_passe }}">
                                </div>
                                <div class="col-5">
                                    <label class="texte">Prix blanchissement(Euro)</label><br>
                                    <input type="text" name="prixBlanchissement" class="form-control"
                                        value="{{ $parametre[0]->prix_blanchissement }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row no-gutters mt-3">
                                <div class="col-5 mr-2">
                                    ...
                                    <input type="text" class="form-control"
                                          value="{{ $parametre[0]->poids_total }}">
                                </div>
                                <div class="col-5">
                                    <label class="texte">Nombre de passe</label><br>
                                    <input type="text" name="prixBlanchissement" class="form-control"
                                        value="{{ $parametre[0]->nb_passe }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="row no-gutters mt-3">
                                <div class="col-5 mr-2">
                                    <label class="texte">Option rouge</label><br>
                                    @if ($parametre[0]->option_valeur==0)
                                         <input type="checkbox" id="checkboxRouge" name="rouge" value="0" checked>
                                        @else
                                        <input type="checkbox" id="checkboxRouge" name="rouge" value="0">
                                    @endif

                                </div>
                                <div class="col-5">
                                    <label class="texte">Option bleu</label><br>
                                     @if ($parametre[0]->option_valeur==1)
                                         <input type="checkbox" id="checkboxBleu" name="bleu" value="1" checked>
                                        @else
                                        <input type="checkbox" id="checkboxBleu" name="bleu" value="1">
                                    @endif
                    ...
                    @else
                        <span class="texte">Il n'y pas encore de parametre de blanchissement sur cette demande</span>
                    @endif
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg-custom" role="document">
                    <div class="modal-content modal-content-custom">
                        <div class="modal-header">
                            <h5 class="modal-title" id="choixEtapeModalLabel">Insertion paramètre blanchissement</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="{{ route('LBT.insertParametreBlanchissement') }}" method="POST"
                                autocomplete="off">
                                @csrf
                                <div class="row">
...
***********************************-->
    ...
    <script>
        ...
        const checkboxRouge = document.getElementById('checkboxRouge');
        const checkboxBleu = document.getElementById('checkboxBleu');

        // Fonction pour gérer l'état des checkboxes
        function toggleCheckboxes() {
            if (checkboxRouge.checked) {
                checkboxBleu.disabled = true;
            } else if (checkboxBleu.checked) {
                checkboxRouge.disabled = true;
            } else {
                checkboxRouge.disabled = false;
                checkboxBleu.disabled = false;
            }
        }

        // Ajouter des écouteurs d'événements
        checkboxRouge.addEventListener('change', toggleCheckboxes);
        checkboxBleu.addEventListener('change', toggleCheckboxes);
    </script>
    <!--**********************************
        Content body end
***********************************-->
