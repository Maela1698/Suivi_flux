@include('CRM.header')
@include('CRM.sidebar')
<title>InspectionBrodMachine</title>
        ...
        <div class="row mt-3">
            <div class="card col-12">
                ...
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">INSPECTION BROD MACHINE</h3>
                </div>

                <form action="{{ route('BRODMACHINE.listeInspectionBroderieMachine') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-3">
