@include('CRM.header')
@include('CRM.sidebar')
<title>consommableBrodMachine</title>
...
<div class="content-body">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="card col-12">
                ...
                <div class="d-flex justify-content-between align-items-center entete">
                    <h3 class="entete mt-3">CONSOMMABLE BROD MACHINE</h3>
                    ...
                    <div class="ml-auto d-flex mr-5">
                        ...
                        <button type="button" class="btn btn-success btn-finish mt-1 btn-sm" style="width: 90px;"
                            data-toggle="modal" data-target="#ajoutConsommable" data-id="" data-iddemande="1">
        ...
        <div class="modal fade" id="ajoutConsommable" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg-custom" role="document">
                <div class="modal-content modal-content-custom">
                    <div class="modal-header">
                        <h5 class="modal-title" id="choixEtapeModalLabel">Insertion consommable</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="row no-gutters mt-3">
                                        <div class="col-12">
                                            <label class="texte">Taille width(cm)</label><br>
                                            <input type="text" class="form-control" name="tailleWidth">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row no-gutters mt-3">
                                        <div class="col-12">
                                            <label class="texte">Taille height(cm)</label><br>
                                            <input type="text" name="tailleHeight" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row no-gutters mt-3">
                                        <div class="col-12">
                                            <label class="texte">Conso viseline(cm2)</label><br>
                                            <input type="text" name="consoViseline" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="row no-gutters mt-3">
                                        <div class="col-12">
                                            <label class="texte">Colle double face(cm2)</label><br>
                                            <input type="text" name="colleFace" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="table-responsive mt-3">
                                        <table class="table" id="dynamicTable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><input type="text" class="form-control" name="couleur[]"></td>
                                                    @for ($i = 0; $i < count($tailles); $i++)
                                                        <td><input type="text" class="form-control" name="conso{{ $tailles[$i]->unite_taille }}[]"></td>
                                                    @endfor
                                                    <td>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        document.querySelector("#dynamicTable").addEventListener("click", function (e) {
            if (e.target.closest(".add-btn")) {
                ...
                // Ajouter la nouvelle ligne en bas du tableau
