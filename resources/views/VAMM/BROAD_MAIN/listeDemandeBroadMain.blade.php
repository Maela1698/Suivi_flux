                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $nbDemande }}</h2>
                            </div>
                        </div>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            <h3 class="card-title text-white" style="margin-bottom: 5px; font-size: calc(0.1em + 1vw);">
                                Nb commande Dev</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $nbDemandeDev }}</h2>
                            </div>
                        </div>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            <h3 class="card-title text-white" style="margin-bottom: 5px; font-size: calc(0.1em + 1vw);">
                                Nb commande Prod</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $nbDemandeProd }}</h2>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="card col-12">
                ...
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">LISTE DES DEMANDES BRODERIE MAIN ET SMOCK</h3>
                </div>
                <form action="{{ route('BRODMAIN.listeBroderieMain') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-1">
                        ...
                        <tbody style="cursor: pointer;">
                            @for ($i = 0; $i < count($demande); $i++)
                                @for ($j = 0; $j < count($nombreInspection); $j++)
                                    <tr>
                                        <td onclick="window.location.href = '{{ route('BRODMAIN.detailDemandeBrodMain', ['idDemande' => $demande[$i]->id_demande_client]) }}';"
                                        ...
                                        <td onclick="window.location.href = '{{ route('BRODMAIN.detailDemandeBrodMain', ['idDemande' => $demande[$i]->id_demande_client]) }}';"
                                            style="cursor: pointer;">{{ $demande[$i]->type_valeur_ajoutee }}</td>
