@include('CRM.header')
@include('CRM.sidebar')
<title>InspectionBrodMain</title>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $pieceProduite[0]->qte }}</h2>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card card-small"
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            <h3 class="card-title text-white" style="margin-bottom: 5px; font-size: calc(0.1em + 1vw);">
                                QuantiteDejaInspectés</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $sommeInspecter[0]->nombre_inspecter }}</h2>
                            </div>
                        </div>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            <h3 class="card-title text-white" style="margin-bottom: 5px; font-size: calc(0.1em + 1vw);">
                                ModeleInspecté</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $nbrInspecter[0]->compte }}</h2>
                            </div>
                        </div>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            <h3 class="card-title text-white" style="margin-bottom: 5px; font-size: calc(0.1em + 1vw);">
                                TauxRejet</h3>
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $sommeTauxRejet[0]->sommeTauxRetouche }}</h2>
                            </div>
                        </div>
                ...
                <div class="card card-small"
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between" style="height: 100%;">
                        <div>
                            ...
                            <div class="d-inline-block">
                                <h2 class="text-white" style="font-size: calc(0.5em + 1vw);">{{ $pourcentageDefaut }}</h2>
                            </div>
                        </div>
        ...
        <div class="row mt-3">
            <div class="card col-12">
                ...
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">INSPECTION BROD MAIN</h3>
                </div>
                <form action="{{ route('BRODMAIN.listeInspectionBroderieMain') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-3">
