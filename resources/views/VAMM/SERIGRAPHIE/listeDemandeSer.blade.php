        ...
        <div class="row mt-3">
            <div class="card col-12">
                ...
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">LISTE DES DEMANDES AVEC SERIGRAPHIE</h3>
                </div>

                <form action="{{ route('SERIGRAPHIE.listeSerigraphie') }}" method="post" autocomplete="off">
                    @csrf
                    <div class="row">
                        <div class="col-1">
                        ...
                        <tbody style="cursor: pointer;">
                            @for ($i = 0; $i < count($demande); $i++)
                                @for ($j = 0; $j < count($nombreInspection); $j++)
                                    <tr>
                                        <td onclick="window.location.href = '{{ route('SERIGRAPHIE.detailDemandeSerigraphie', ['idDemande' => $demande[$i]->id_demande_client]) }}';"
                                        ...
                                        <td onclick="window.location.href = '{{ route('SERIGRAPHIE.detailDemandeSerigraphie', ['idDemande' => $demande[$i]->id_demande_client]) }}';"
                                            style="cursor: pointer;">{{ $demande[$i]->smv_print }}</td>

                                        <td onclick="window.location.href = '{{ route('SERIGRAPHIE.detailDemandeSerigraphie', ['idDemande' => $demande[$i]->id_demande_client]) }}';"
                                            style="cursor: pointer;">{{ $demande[$i]->prix_print }}</td>
