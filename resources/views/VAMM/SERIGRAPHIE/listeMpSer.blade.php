        ...
        <div class="row">
            <div class="card col-12">
                <div class="justify-content-center align-items-center entete">
                    <h3 class="entete mt-3">LISTE DES MATIERES PREMIERES SERIGRAPHIE</h3>
                    <center>
                                ...
                                @for ($i = 0; $i < count($listeTissu); $i++)
                                    <tr>
                                        ...
                                        <form id="detailForm{{ $i }}"
                                            action="{{ route('SERIGRAPHIE.detailTissuSer') }}" method="GET"
                                            style="display:none;">
                                            @csrf
                                ...
                                @for ($j = 0; $j < count($listeAcc); $j++)
                                    <tr>
                                        ...
                                        <form id="detailFormA{{ $j }}"
                                            action="{{ route('SERIGRAPHIE.detailAccessoireSer') }}" method="get"
                                            style="display:none;">
                                            @csrf
