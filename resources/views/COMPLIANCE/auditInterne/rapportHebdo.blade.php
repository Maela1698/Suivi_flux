@include('CRM.header')
@include('CRM.sidebar')
@include('COMPLIANCE.STYLE.styleRapportHebdoAuditInterne')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="card col-lg-12">
                ...
                <div class="card-body">
                    <form action="{{ route('AUDITINTERNE.rapportHebdo') }}" method="GET">
                        <div class="row align-items-end">
                            <div class="col-lg">
                                <label>Date Constat</label>
                                <input class="form-control" id="daterange" type="text" name="daterange" value="{{ request('daterange') }}">
                            </div>
...
@include('COMPLIANCE.JS.jsRapportHebdo')
@include('CRM.footer')
