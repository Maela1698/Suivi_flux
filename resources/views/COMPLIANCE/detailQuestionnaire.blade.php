        ...
        <div class="col-md-12">
            <div class="card col-12 carte">
                <div class="card-header entete text-center">
                    <h3 class="mt-3">DETAILS QUESTIONNAIRE</h3>
                </div>
                <div class="card-body">
                    <div class="row g-0" style="background-color: rgb(239, 238, 238); border-radius: 10px;">
                        <div class="col-md-5">
                            <div class="card-body">
                                ...
                                <p class="texte"><b>Axe :</b> {{ $questionnairesbyid[0]->axe }}</p>
                                <p class="texte"><b>Question :</b> {{ $questionnairesbyid[0]->question }}</p>
                                <p class="texte"><b>Statut :</b> {{ $questionnairesbyid[0]->statut }}</p>
                                <p class="texte"><b>Type Périmètre :</b> {{ $questionnairesbyid[0]->typeperimetre }}
                                </p>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('COMPLIANCE.ajoutConstatPerimetre') }}" method="POST"
