        ...
        <div class="col-md-12">
            <div class="card col-12 carte">
                <div class="d-flex justify-content-between align-items-center entete">
                    ...
                    <h3 class="entete mt-3">DETAILS CONSTAT PERIMETRE</h3>
                    <div class="ml-auto d-flex">
                        <button type="button" class="btn btn-success btn-finish mt-1 btn-sm" style="width: 190px;"
                            data-toggle="modal" data-target="#planAction" data-id="" data-iddemande="1">
                    ...
                    <div class="row g-0" style="background-color: rgb(239, 238, 238); border-radius: 10px;">
                        ...
                        <div class="col-md-10">
                            <div class="card-body">
                                ...
                                <p class="texte"><b>Priorite :</b>{{ $constat[0]->question }}</p>
                        ...
                        <div class="col-lg-8 ml-auto text-right d-flex justify-content-end">
                            <form action="{{ route('COMPLIANCE.listeConstat') }}" method="GET">
                                <button type="submit" class="btn btn-danger mr-3"
                                    style="width: 100px; height: 40px">Supprimer</button>
                            </form>
                            <button type="button" data-toggle="modal" data-target="#constat"
                                style="width: 100px; height: 40px" class="btn btn-warning mr-3">Modifier</button>
                            <form action="{{ route('COMPLIANCE.listeConstatPerimetre') }}" method="GET">
                                <button type="submit" class="btn btn-info mr-3" style="width: 100px; height: 40px">Voir
                                    liste</button>
                            </form>
                        </div>
