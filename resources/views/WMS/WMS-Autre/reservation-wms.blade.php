    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header py-3">
                <h4 class="text-primary m -0 font-weight-bold">Liste de Réservation </h4>
            </div>
            <div class="card-body">
                                    ...
                                    @if ($historyReservations->validation == 1 && $historyReservations->etat_reservation == 0)
                                        <td>
                                            <a class="btn btn-success"
                                                href="{{ route('WMS.validation-reservation-wms', ['idreservation' => $historyReservations->idreservation]) }}"
                                        ...
                                        <div class="modal-content" style="background-color: white">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="modification-form"
                                                    action="{{ route('WMS.sortie-reservation-wms') }}" method="post"
                                                    ...
                                                    <div class="mb-3"><label class="form-label">Destinataire</label>
                                                        <input class="form-control" type="text" name="destinataire">
                                                    </div>
                                ...
                                <div class="modal" id="suppression-modal-{{ $historyReservations->idreservation }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="background-color: white">
                                            ...
                                            <div class="modal-body">
                                                <form method="GET"
                                                    action="{{ route('WMS.annulation-reservation-wms', ['idreservation' => $historyReservations->idreservation]) }}">
                                                    @csrf
                                ...
                                <div class="modal" id="refus-modal-{{ $historyReservations->idreservation }}">
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="background-color: white">
                                            ...
                                            <div class="modal-body">
                                                <form method="GET"
                                                    action="{{ route('WMS.refus-reservation-wms', ['idreservation' => $historyReservations->idreservation]) }}">
                                                    @csrf
                                                    <p class="alert alert-danger" style="color: black">
                                                        Voulez-vous
                                                        vraiment
