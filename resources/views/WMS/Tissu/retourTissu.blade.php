    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header py-3">
                <h4 class="text-primary m -0 font-weight-bold">Retour {{ $familleTissu->famille_tissus }}</h4>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive table mt-2" id="dataTable" role="grid"
                    ...
                    <table class="table my-0" id="dataTable">
                        ...
                        <tbody style="color: black">
                            @foreach ($historyRetour as $historyRetours)
                                <tr>
                                    <th>{{ $historyRetours->designation }}</th>
                                    <th>{{ $historyRetours->reference }}</th>
                                    <th>{{ $historyRetours->composition }}</th>
                                    <th>{{ $historyRetours->categorie }}</th>
                                    <th>{{ $historyRetours->couleur }}</th>
                                    <th>{{ $historyRetours->classe }}</th>
                                    {{-- TODO: Formater cette date --}}
                                    <th>{{ $historyRetours->dateretour }}</th>
                                    <th>{{ $historyRetours->qteretour }}</th>
                                    <th>{{ $historyRetours->commentaire }}</th>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
