    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-header py-3">
                <h4 class="text-primary m -0 font-weight-bold">Entrée Chaîne et trame</h4>
                <form action="{{ route('WMS.ct-entree') }}" method="get">
                    @csrf
                    ...
                    <table class="table my-0" id="dataTable">
                        ...
                        <tbody>
                            @foreach ($historyEntree as $historyEntrees)
                                <tr>
                                    <th>{{ $historyEntrees->des_rack . '' . $historyEntrees->des_cellule }}</th>
                                    <th>{{ $historyEntrees->parite }}</th>
                                    ...
                                    <th>{{ $historyEntrees->unitemonetaire }}</th>
