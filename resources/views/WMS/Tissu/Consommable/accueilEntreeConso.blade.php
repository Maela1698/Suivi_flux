            ...
            <div class="card-body">
                ...
                <div class="table-responsive table mt-2" id="dataTable" role="grid"
                    ...
                    <table class="table my-0" id="dataTable">
                        ...
                        <tbody>
                            @foreach ($historyConso as $historyConsos)
                                <tr>
                                    <th>{{ $historyConsos->valeur }}</th>
                                    <th>{{ $historyConsos->dateentree }}</th>
                                    <th>{{ $historyConsos->datefacturation }}</th>
                                    <th>{{ $historyConsos->categorie }}</th>
                                    <th>{{ $historyConsos->classe }}</th>
                                    <th>{{ $historyConsos->utilisation }}</th>
                                    <th>{{ $historyConsos->numerobc }}</th>
                                    <th>{{ $historyConsos->numerobl }}</th>
                                    <th>{{ $historyConsos->numerofacture }}</th>
                                    <th>{{ $historyConsos->fournisseur }}</th>
                                    <th>{{ $historyConsos->client }}</th>
                                    <th>{{ $historyConsos->modele }}</th>
                                    <th>{{ $historyConsos->saison }}</th>
                                    <th>{{ $historyConsos->des_tissu }}</th>
                                    <th>{{ $historyConsos->reftissu }}</th>
                                    <th>{{ $historyConsos->composition }}</th>
                                    <th>{{ $historyConsos->couleur }}</th>
                                    <th>{{ $historyConsos->laize }}</th>
                                    <th>{{ $historyConsos->qtecommande }}</th>
                                    <th>{{ $historyConsos->unite_mesure }}</th>
                                    <th>{{ $historyConsos->qterecu }}</th>
                                    <th>{{ $historyConsos->tauxecart . '%' }}</th>
                                    <th>{{ $historyConsos->nbrouleau }}</th>
                                    <th>{{ $historyConsos->nblot }}</th>
                                    <th>{{ $historyConsos->prixunitaire }}</th>
                                    <th>{{ $historyConsos->unite_monetaire }}</th>
                                    <th>{{ $historyConsos->resterecevoir }}</th>
                                    <th>{{ $historyConsos->fret }}</th>
                                    <th>{{ $historyConsos->commentaire }}</th>
