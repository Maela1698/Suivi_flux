...
use App\Http\Controllers\ControllerWMS;
...
use App\Http\Controllers\QUALITECONTROLLER\FiltreQualiteTissu;
use App\Http\Controllers\QUALITECONTROLLER\PageQualite;
use App\Http\Controllers\QUALITECONTROLLER\QUALITEController;
use App\Http\Controllers\WMSCONTROLLER\AutoCompleteController;
use App\Http\Controllers\WMSCONTROLLER\FiltreTissuController;
use App\Http\Controllers\WMSCONTROLLER\TissuController;
use App\Http\Controllers\WMSCONTROLLER\WMS_AUTRE\FiltreWMSController;
use App\Http\Controllers\WMSCONTROLLER\WMS_AUTRE\WMSController;
...
Route::get('/autocomplete-num-bc', [AutoCompleteController::class, 'autocomplete_num_bc'])->name('WMS.autocomplete-num-bc');
Route::get('/autocomplete-des-tissu', [AutoCompleteController::class, 'autocomplete_des_tissu'])->name('WMS.autocomplete-des-tissu');
Route::get('/autocomplete-ref-tissu', [AutoCompleteController::class, 'autocomplete_ref_tissu'])->name('WMS.autocomplete-ref-tissu');
Route::get('/autocomplete-couleur-tissu', [AutoCompleteController::class, 'autocomplete_couleur_tissu'])->name('WMS.autocomplete-couleur-tissu');
Route::get('/autocomplete-cellule-tissu', [AutoCompleteController::class, 'autocomplete_cellule_tissu'])->name('WMS.autocomplete-cellule-tissu');
Route::get('/autocomplete-fournisseur', [AutoCompleteController::class, 'autocomplete_fournisseur'])->name('WMS.autocomplete-fournisseur');
Route::get('/autocomplete-client', [AutoCompleteController::class, 'autocomplete_client'])->name('WMS.autocomplete-client');

/*--------------------------------Page wms--------------------------------*/
Route::get('/accueil-WMS', [ControllerWMS::class, 'wms_page_accueil'])->name('WMS.accueil');
Route::get('/parite-WMS', [ControllerWMS::class, 'wms_page_parite'])->name('WMS.parite');
Route::get('/section-WMS', [ControllerWMS::class, 'wms_page_section'])->name('WMS.section');
Route::get('/rack-WMS', [ControllerWMS::class, 'wms_page_rack'])->name('WMS.rack');
Route::get('/cellule-WMS/{idrack}', [ControllerWMS::class, 'wms_page_cellule'])->name('WMS.cellule');
Route::get('/utilisation-WMS', [ControllerWMS::class, 'wms_page_utilisation'])->name('WMS.utilisation');
Route::get('/magasin-tissu-WMS', [ControllerWMS::class, 'wms_page_magasin_tissu'])->name('WMS.magasin-tissu');
Route::get('/tissu-entree-accueil/{idFamilleTissu}', [ControllerWMS::class, 'wms_page_tissu_entree_accueil'])->name('WMS.tissu-entree-accueil');
Route::get('/tissu-entree/{idfamilletissus}', [ControllerWMS::class, 'wms_page_tissu_entree'])->name('WMS.tissu-entree');
Route::get('/tissu-stock/{idFamilleTissu}', [ControllerWMS::class, 'wms_page_tissu_stock'])->name('WMS.tissu-stock');
Route::match(['get', 'post'], '/modificationCellule', [ControllerWMS::class, 'modificationCellule'])->name('WMS.modificationCellule');
Route::get('/tissu-stock-obsolete', [ControllerWMS::class, 'wms_page_tissu_stock_obsolete'])->name('WMS.tissu-stock-obsolete');
Route::get('/tissu-sortie-accueil/{idFamilleTissu}', [ControllerWMS::class, 'wms_page_tissu_sortie_accueil'])->name('WMS.tissu-sortie-accueil');
Route::get('/retour-tissu-historique/{idFamilleTissu}', [ControllerWMS::class, 'wms_page_retour_tissu'])->name('WMS.retour-tissu-historique');
Route::get('/reservation-tissu-historique', [ControllerWMS::class, 'wms_page_reservation_tissu'])->name('WMS.reservation-tissu-historique');
Route::get('/tissu-sortie/{idStock}', [ControllerWMS::class, 'wms_page_tissu_sortie'])->name('WMS.tissu-sortie');
Route::get('/rajout-tscf-tissu/{idStock}', [ControllerWMS::class, 'wms_page_rajout_tscf_tissu'])->name('WMS.rajout-tscf-tissu');
Route::get('/rajout-tissu/{iddonnebc?}/{idStock}', [TissuController::class, 'rajout_stock'])->name('WMS.rajout-tissu');
Route::get('/rajout-tissu-sans-tscf/{idStock}', [ControllerWMS::class, 'wms_page_tissu_rajout_tissu'])->name('WMS.rajout-tissu-sans-tscf');
Route::get('/page-tissu-obsolete-sortie', [ControllerWMS::class, 'wms_page_tissu_obolete_sortie_accueil'])->name('WMS.page-tissu-obsolete-sortie');
/*--------------------------------Tissu wms--------------------------------*/
Route::post('/ajout-entree-tissu', [TissuController::class, 'ajout_entre_tissu'])->name('WMS.ajout-entree-tissu');
Route::post('/modif-entree-tissu', [TissuController::class, 'modif_entree_tissu'])->name('WMS.modif-entree-tissu');
Route::get('/ajout-entree-tissu-par-bc/{iddonnebc}/{idfamilletissu}', [TissuController::class, 'ajout_entree_tissu_par_bc'])->name('WMS.ajout-entree-tissu-par-bc');
Route::post('/insert-rajout', [TissuController::class, 'insert_rajout'])->name('WMS.insert-rajout');
Route::post('/sortie-stock-tissu', [TissuController::class, 'sortie_stock_tissu'])->name('WMS.sortie-stock-tissu');
Route::post('/retour-tissu', [TissuController::class, 'retour_tissu'])->name('WMS.retour-tissu');
Route::post('/ajout-reservation-tissu', [TissuController::class, 'ajout_reservation_Tissu'])->name('WMS.ajout-reservation-tissu');
Route::post('/sortie-reservation-tissu', [TissuController::class, 'sortie_reservation_tissu'])->name('WMS.sortie-reservation-tissu');
Route::get('/annulation-reservation-tissu/{idreservation}', [TissuController::class, 'annulation_reservation'])->name('WMS.annulation-reservation-tissu');
Route::get('/validation-reservation-tissu/{idreservation}', [TissuController::class, 'validation_reservation'])->name('WMS.validation-reservation-tissu');
Route::get('/refus-reservation-tissu/{idreservation}', [TissuController::class, 'refus_reservation'])->name('WMS.refus-reservation-tissu');
Route::get('/obsolete-tissu/{idstocktissu}', [TissuController::class, 'obsolete_Tissu'])->name('WMS.obsolete-tissu');
Route::get('/retour-tissu-wms-type', [TissuController::class, 'retourTissuWMS'])->name('WMS.retour-tissu-wms-type');
Route::post('/enregistrer/{modelName}', [CRUDController::class, 'inserer'])->name('enregistrer');
//   Route::get('/parite-WMS', [ControllerWMS::class, 'wms_page_parite'])->name('WMS.parite');
Route::post('/modifier/{modelName}/{id}', [CRUDController::class, 'modifier'])->name('modifier');
Route::post('/supprimer/{modelName}/{id}', [CRUDController::class, 'supprimer'])->name('supprimer');
/*--------------------------------Filtre tissu wms--------------------------------*/
// Route::get('/filtre-entree-tissu', [FiltreTissuController::class, 'filtreEntreeTissu'])->name('WMS.filtre-entree-tissu');
Route::get('/filtre-tissu-entree', [FiltreTissuController::class, 'filtreEntreeTissu'])->name(('WMS.filtre-tissu-entree'));
Route::get('/filtre-stock-tissu', [FiltreTissuController::class, 'filtreStockTissu'])->name('WMS.filtre-stock-tissu');
Route::get('/filtre-stock-tissu-obsolete', [FiltreTissuController::class, 'filtreStockTissuObsolete'])->name('WMS.filtre-stock-tissu-obsolete');
Route::get('/filtre-sortie-tissu/{idfamilletissu}', [FiltreTissuController::class, 'filtreSortieTissu'])->name('WMS.filtre-sortie-tissu');
...
Route::get('/page-magasin-wms/{idtypewms}', [PageWMSController::class, 'page_magasin_wms'])->name('WMS.page-magasin-wms');
Route::get('/page-accueil-entree-wms/{idtypewms}', [PageWMSController::class, 'page_accueil_entree_wms'])->name('WMS.page-accueil-entree-wms');
Route::get('/page-entree-wms/{idtypewms}', [PageWMSController::class, 'page_entree_wms'])->name('WMS.page-entree-wms');
Route::get('/page-stock-wms/{idtypewms}', [PageWMSController::class, 'page_stock_wms'])->name('WMS.page-stock-wms');
Route::get('/page-accueil-sortie-wms/{idtypewms}', [PageWMSController::class, 'page_accueil_sortie_wms'])->name('WMS.page-accueil-sortie-wms');
Route::get('/page-sortie-wms/{idtypewms}', [PageWMSController::class, 'page_sortie_wms'])->name('WMS.page-sortie-wms');
Route::get('/page-retour-wms/{idtypewms}', [PageWMSController::class, 'page_retour_wms'])->name('WMS.page-retour-wms');
Route::get('/page-obsolete-accessoire', [PageWMSController::class, 'page_obsolete_accessoire'])->name('WMS.page-obsolete-accessoire');
Route::get('/reservation-wms-historique', [PageWMSController::class, 'wms_page_reservation_wms'])->name('WMS.reservation-wms-historique');


Route::post('/ajout-entree-wms', [WMSController::class, 'ajout_entre_wms'])->name('WMS.ajout-entree-wms');
Route::post('/modif-entree-wms', [WMSController::class, 'modif_entree_wms'])->name('WMS.modif-entree-wms');
Route::get('/filtre-entree-wms/{idtypewms}', [FiltreWMSController::class, 'filtreEntreeWMS'])->name('WMS.filtre-entree-wms');
Route::get('/filtre-stock-wms', [FiltreWMSController::class, 'filtreStockWMS'])->name('WMS.filtre-stock-wms');
Route::get('/filtre-sortie-wms', [FiltreWMSController::class, 'filtreSortieWMS'])->name('WMS.filtre-sortie-wms');
Route::post('/sortie-stock-wms', [WMSController::class, 'sortie_stock_wms'])->name('WMS.sortie-stock-wms');
Route::post('/retour-stock-wms', [WMSController::class, 'retour_wms'])->name('WMS.retour-stock-wms');
Route::post('/rajout-stock-wms', [WMSController::class, 'insert_rajout'])->name('WMS.rajout-stock-wms');
Route::get('/rendre-obsolete-accessoire/{idstockaccessoire}', [WMSController::class, 'obsolete_Accessoire'])->name('WMS.rendre-obsolete-accessoire');
Route::get('/retour-wms-wms-type', [WMSController::class, 'retourWMSWMS'])->name('WMS.retour-wms-wms-type');
Route::post('/ajout-reservation-wms', [WMSController::class, 'ajout_reservation_wms'])->name('WMS.ajout-reservation-wms');
Route::post('/sortie-reservation-wms', [WMSController::class, 'sortie_reservation_wms'])->name('WMS.sortie-reservation-wms');
Route::get('/annulation-reservation-wms/{idreservation}', [WMSController::class, 'annulation_reservation'])->name('WMS.annulation-reservation-wms');
Route::get('/validation-reservation-wms/{idreservation}', [WMSController::class, 'validation_reservation'])->name('WMS.validation-reservation-wms');
Route::get('/refus-reservation-wms/{idreservation}', [WMSController::class, 'refus_reservation'])->name('WMS.refus-reservation-wms');


/*--------------------------------Page qualité--------------------------------*/
Route::get('/entree-tissu-qualite', [PageQualite::class, 'entreeQualiteTissu'])->name('QUALITE.entree-tissu-qualite');
Route::get('/page-entree-rouleau-qualite/{identreetissu}', [PageQualite::class, 'page_ajout_rouleau_qualite'])->name('QUALITE.page-entree-rouleau-qualite');
Route::get('/page-test-conformite-tissu/{identreetissu}', [PageQualite::class, 'page_test_conformite_tissu'])->name('QUALITE.page-test-conformite-tissu');
Route::get('/page-test-fabric-inspection/{identreetissu}', [PageQualite::class, 'page_test_fabric_inspection'])->name('QUALITE.page-test-fabric-inspection');
Route::get('/page-test-fabric-inspection-defaut/{idqualiterouleautissu}/{identreetissu}', [PageQualite::class, 'page_test_fabric_inspection_default'])->name('QUALITE.page-test-fabric-inspection-defaut');
Route::get('/page-test-elongation-retraction/{identreetissu}', [PageQualite::class, 'page_test_elongation_retraction'])->name('QUALITE.page-test-elongation-retraction');
Route::get('/page-test-nuance/{identreetissu}', [PageQualite::class, 'page_test_nuance'])->name('QUALITE.page-test-nuance');
Route::get('/page-test-disgorging/{identreetissu}', [PageQualite::class, 'page_test_disgorging'])->name('QUALITE.page-test-disgorging');
Route::get('/page-rapport-inspection-tissu/{identreetissu}', [PageQualite::class, 'rapportInspectionTissu'])->name('QUALITE.page-rapport-inspection-tissu');
Route::get('/entree-accessoire-qualite', [PageQualite::class, 'entreeQualiteAccesoire'])->name('QUALITE.entree-accessoire-qualite');
Route::get('/inspection-accessoire-qualite/{idfamillewms}/{identreewms}', [PageQualite::class, 'inspectionQualiteAccesoire'])->name('QUALITE.inspection-accessoire-qualite');

/*--------------------------------Filtre qualite--------------------------------*/
Route::get('/filtre-entree-tissu', [FiltreQualiteTissu::class, 'filtreEntreeTissu'])->name('QUALITE.filtre-entree-tissu');

Route::post('/import-rouleau-qualite-tissu', [QUALITEController::class, 'importRouleauQualiteTissu'])->name('QUALITE.import-rouleau-qualite-tissu');
Route::post('/test-conformite', [QUALITEController::class, 'testConformite'])->name('QUALITE.test-conformite');
Route::post('/test-fabric-inspection', [QUALITEController::class, 'testFabricInspection'])->name('QUALITE.test-fabric-inspection');
Route::post('/test-liste-rouleau-fabric-inspection', [QUALITEController::class, 'listeRouleauFabricInspection'])->name('QUALITE.test-liste-rouleau-fabric-inspection');
Route::post('/test-fabric-inspection-defaut', [QUALITEController::class, 'testFabricInspectionDefaut'])->name('QUALITE.test-fabric-inspection-defaut');
Route::post('/test-retraction', [QUALITEController::class, 'testRetraction'])->name('QUALITE.test-retraction');
Route::post('/test-retraction-rouleau', [QUALITEController::class, 'testRetractionRouleau'])->name('QUALITE.test-retraction-rouleau');
Route::post('/test-nuance', [QUALITEController::class, 'testNuance'])->name('QUALITE.test-nuance');
Route::post('/test-nuance-rouleau', [QUALITEController::class, 'testNuanceRouleau'])->name('QUALITE.test-nuance-rouleau');
Route::post('/test-disgorging', [QUALITEController::class, 'testDisgorging'])->name('QUALITE.test-disgorging');
Route::post('/test-disgorging-rouleau', [QUALITEController::class, 'testDisgorgingRouleau'])->name('QUALITE.test-disgorging-rouleau');
Route::post('/test-inspection-accessoire', [QUALITEController::class, 'inspectionAccessoire'])->name('QUALITE.test-inspection-accessoire');

// export csv
Route::get('/exportCSVEntreeTissu', [ControllerWMS::class, 'exportCSVEntreeTissu'])->name('WMS.exportCSVEntreeTissu');
Route::get('/exportCSVStockTissu', [ControllerWMS::class, 'exportCSVStockTissu'])->name('WMS.exportCSVStockTissu');
Route::get('/exportCSVSortieTissu', [ControllerWMS::class, 'exportCSVSortieTissu'])->name('WMS.exportCSVSortieTissu');
